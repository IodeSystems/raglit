...
// Measured on the fence-dispute SMS exhibit: 15 pages, all read by the VLM, 15% of the
...
const screenshotPage = `<div data-bbox="0 0 1000 90" data-label="Image">` +
	...
	`<div data-bbox="0 100 1000 700" data-label="Text"><p>Milo: the surveyor is coming Thursday to set the corners</p>` +
	`<p>Nadia: ok I will be there, bring the plat map please</p></div>` +
...
func TestMixedPage_FigureMarkersAreDescription(t *testing.T) {
	page := "Harrow Brand & Teal\n(555) 010-4477 (Phone)\n\n" +
		"[FIGURE: Logo for Harrow Brand & Teal, the letters H, B and T intertwined in a circular design]\n\n" +

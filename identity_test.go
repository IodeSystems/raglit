...
and BRANNOCK, seller, for the property at 1440 North Northlea Road. The buyer
...
func TestIdentify_ReturnsCaptionSummaryKind(t *testing.T) {
	c := &identityChatter{replies: []string{
		`{"name":"2021-05-25 Form 21 purchase and sale agreement (Ardley/Brannock)",
		  "summary":"The buyer's signed offer for 1440 North Northlea Road, dated April 9 2019, between Ardley and Brannock, closing June 3 2019.",
		  "kind":"agreement",
...
func machineIdentity() DocIdentity {
	return DocIdentity{
		Name:    "2021-05-25 Form 21 purchase and sale agreement (Ardley/Brannock)",
		Summary: "The executed purchase and sale agreement for 1440 North Northlea Road.",
...
func TestIdentityText_PrefersTheCorrectedReading(t *testing.T) {
	...
	const corrected = "Record of survey certified by Mara Dace, certificate number 20150311 0045."
	...
	if !strings.Contains(got, "Mara Dace") || !strings.Contains(got, "20150311 0045") {

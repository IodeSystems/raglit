...
25.00 feet thereof, as more particularly described in AF#201503110043.
...
THE LAW OFFICE OF NETTLE & VOLE PLLC, THAT MAY BE PRIVILEGED,
...
func TestDisagreeingCopiesSurfaceTheChangedNumbers(t *testing.T) {
	...
	altered := FoldPages(pages(strings.NewReplacer(
		...
		"AF#201503110043", "AF#201503110044",
...
func varied(n int) string {
	...
	for i := 0; i < n; i++ {
		b.WriteString("Recital " + itoa(i) + ": the grantor conveys parcel P" +
			...
			" of the centerline described in AF#20150311" + itoa(1000+i) + ". ")
	}
	return b.String()
}

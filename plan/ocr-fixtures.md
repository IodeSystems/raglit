...
**1. Text and drawing on one sheet — `records/201907220018-2022-dace-ROS-disputed.pdf` p1**
...
| fact | truth |
|---|---|
| surveyor | MARA G. DACE |
| certificate | 20123169 |
| note 2 auditor's file number | 201907220016 |
| deed auditor's file number | 201503110045 |
| recording number | 201907220018 |
...
**3. A scanned multi-page instrument — `evidence/icloud-2026-07-25/decoded/attachments/2019-04-09-PSA-OFFER-buyer-signed-30pg-MISNAMED-as-form22J__40118802.pdf`**
...
**4. A drawing with no prose — `correspondence/attachments/…Access_permit_-_Ivo_Larkin__1636_001.pdf` p4**
...
It has a second copy — `records/2019-04-havern-access-permit-AC19-0044-with-1993-qcd.pdf`
...
|---|---|---|---|---|
| 200 DPI, no assist (was production) | ✗ 201364 | ✗ | ✗ 2015031104 | ✗ IN DEED DACF |
| 400 DPI, no assist | ✓ | ✗ | ✓ | ✗ DACF |
| 400 DPI + tesseract text, whole | ✗ 20123164 | ✗ | ✓ | ✓ DACE |
...
not on the page, and `EXISTING CORNERS`, `REBAR`, `CALC`, `201907220018` all
...
`9404150061` is the number this page is KNOWN for confabulating as
`A#201404150061` — a real number with 200 prepended and a digit dropped. The

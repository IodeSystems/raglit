...
Recovered page 9 of the dace exhibit, a Record of Survey filed on its side,
...
**Root descriptions are not quotable.** A sheet read whole returns `DACF` for
Dace and drops digits from auditor file numbers. That is the division of

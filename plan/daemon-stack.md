...
daemon. On 2026-08-09 every `.docx` attachment extracted from the fence-dispute corpus
...
SEPARATE BUG, found while verifying the above and NOT fixed:
    ...
    /api/problems?project=bramble-v-quill&index=default   ->   4 docs,  0 problems
    /api/problems?index=bramble-v-quill__default          -> 481 docs, 64 problems

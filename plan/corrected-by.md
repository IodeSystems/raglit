...
## The case that shows it — AF 201907220018

The 2022 Dace record of survey states, on its own face:

> "THIS SURVEY IS A CORRECTION TO THE BOUNDARY OF LOT 'I' … ORIGINALLY RECORDED
> UNDER HAVERN COUNTY AUDITOR'S FILE NO. **201503110045**"
>
...
> AUDITOR'S FILE NO. **201907220017** IS N[OT correct] WITH RESPECT TO THE
> NEIGHBOR'S SHED"

Two different relations in one sheet:

1. **It corrects a different instrument.** The 2008 Summit survey is not a version
   of the 2022 Dace survey — different surveyor, different year, different
   ...
   nothing.
2. **It corrects ONE NOTE of another document.** Not the whole of AF 201907220017 —
...
**Proposed by reading, ruled by a person.** The Dace survey says what it
...
document states that it corrects AF 201503110045" — a candidate, resolvable to a

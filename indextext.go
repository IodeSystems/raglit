...
//
//	measured on the fence-dispute corpus 2026-08-10
...
// measured on the fence-dispute index, 768 cached pages carry layout markup and 201
// carry figure markers, with no overlap. Counting only the first scored a page
// whose only description is `[FIGURE: Logo for Harrow Brand & Teal…]` at zero,
...
// together with no seam. Measured on the fence-dispute index: 654 of 1422 cached vision
// pages are like this.
//
...
// and camera buttons.
//
//	measured on the fence-dispute SMS exhibit 2026-08-15

...
func TestCommitDoc_ReArmsWhenTheTextChangesUnderACaption(t *testing.T) {
	...
	commit("EXHIBIT A. Legal description of the parcel, metes and bounds, together with the appurtenant easement recorded under auditor's file number 201907220016, and the signatures of both parties, witnessed and acknowledged before a notary public in and for the State of Washington, residing at Havern.")

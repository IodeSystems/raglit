...
// The real thing chandra returns for a photograph, captured from the fence-dispute
...
const faxTranscription = `<div data-bbox="100 90 900 200" data-label="Text"><p>DACE & ASSOCIATES, PLLC</p><p>18 Sedge Street, PO Box 4400</p><p>Havern, Washington 98999-0100</p></div>` +
	`<div data-bbox="100 210 900 400" data-label="Text"><p>DATE April 9, 2019</p><p>FACSIMILE TRANSMITTAL</p><p>To: Milo and Nadia Quill</p><p>Re: Record of Survey</p></div>`
...
// each changed meaning the moment they did. Measured on the fence-dispute photo sets:
...
func TestDescribedFraction_MixedIsNeitherPureCase(t *testing.T) {
	...
	mixed := `<div data-bbox="0 0 1000 120" data-label="Image"><img alt="A phone status bar showing battery, wifi and the time, with app icons below."/></div>` +
		`<div data-bbox="0 130 1000 900" data-label="Text"><p>Milo: the surveyor is coming Thursday to set the corners</p>` +
		`<p>Nadia: ok I will be there, bring the plat map please</p>` +
		`<p>Milo: already have it in the truck, see you at nine</p></div>`

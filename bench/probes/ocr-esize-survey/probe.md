...
| fact | truth |
|---|---|
| the quitclaim's auditor file number | `9404150061` |
...
`A#201404150061` is the specific invention this page produced for that file
...
- response_contains: 9404150061
- response_contains: MOWRER
- response_contains: SUMMIT
- response_contains: WESTERLY
- response_not_contains: A#201404150061
- response_not_contains: 201404150061
